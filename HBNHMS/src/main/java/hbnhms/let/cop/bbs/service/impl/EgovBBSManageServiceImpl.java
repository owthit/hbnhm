...
import hbnhms.com.cmm.service.EgovFileMngService;
import hbnhms.com.cmm.service.FileVO;
import hbnhms.let.cop.bbs.service.Board;
import hbnhms.let.cop.bbs.service.BoardVO;
import hbnhms.let.cop.bbs.service.EgovBBSManageService;
import hbnhms.let.utl.fcc.service.EgovDateUtil;
...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#deleteBoardArticle(hbnhms.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#insertBoardArticle(hbnhms.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticle(hbnhms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(hbnhms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#updateBoardArticle(hbnhms.let.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#deleteGuestList(hbnhms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see hbnhms.let.cop.bbs.brd.service.EgovBBSManageService#selectGuestList(hbnhms.let.cop.bbs.brd.service.BoardVO)
     */
