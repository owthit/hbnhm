package hbnhms.let.cop.com.service.impl;
...
import hbnhms.let.cop.com.service.BoardUseInf;
import hbnhms.let.cop.com.service.BoardUseInfVO;
import hbnhms.let.cop.com.service.EgovBBSUseInfoManageService;
...
public class EgovBBSUseInfoManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSUseInfoManageService {
     ...
     * 게시판 사용 정보를 삭제한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovBBSUseInfoManageService#deleteBBSUseInf(hbnhms.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 게시판 사용정보를 등록한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovBBSUseInfoManageService#insertBBSUseInf(hbnhms.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 게시판 사용정보 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovBBSUseInfoManageService#selectBBSUseInfs(hbnhms.let.cop.bbs.com.service.BoardUseInfVO)
     */
     ...
     * 게시판 사용정보를 수정한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovBBSUseInfoManageService#updateBBSUseInf(hbnhms.let.cop.bbs.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovBBSUseInfoManageService#selectBBSUseInf(hbnhms.let.cop.bbs.com.service.BoardUseInfVO)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByClub(hbnhms.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByCmmnty(hbnhms.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#deleteAllBBSUseInfByClub(hbnhms.let.cop.com.service.BoardUseInfVO)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#deleteAllBBSUseInfByCmmnty(hbnhms.let.cop.com.service.BoardUseInfVO)
     */
     ...
     * 게시판에 대한 사용정보를 삭제한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#deleteBBSUseInfByBoardId(hbnhms.let.cop.com.service.BoardUseInf)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovBBSUseInfoManageService#selectBBSUseInfsByTrget(hbnhms.let.cop.com.service.BoardUseInfVO)
     */
