...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectClubUserList(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectUserList(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(hbnhms.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see hbnhms.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(hbnhms.let.cop.com.service.UserInfVO)
     */
