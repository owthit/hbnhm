...
import hbnhms.let.cop.com.service.EgovTemplateManageService;
import hbnhms.let.cop.com.service.TemplateInf;
import hbnhms.let.cop.com.service.TemplateInfVO;
...
public class EgovTemplateManageServiceImpl extends EgovAbstractServiceImpl implements EgovTemplateManageService {
     ...
     * 템플릿 정보를 삭제한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#deleteTemplateInf(hbnhms.let.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿 정보를 등록한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#insertTemplateInf(hbnhms.let.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿에 대한 상세정보를 조회한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#selectTemplateInf(hbnhms.let.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 템플릿에 대한 목록를 조회한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#selectTemplateInfs(hbnhms.let.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#selectTemplatePreview(hbnhms.let.cop.bbs.com.service.TemplateInfVO)
     */
     ...
     * 템플릿 정보를 수정한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#updateTemplateInf(hbnhms.let.cop.bbs.com.service.TemplateInf)
     */
     ...
     * 템플릿 구분에 따른 목록을 조회한다.
     * 
     * @see hbnhms.let.cop.bbs.com.service.EgovTemplateManageService#selectAllTemplateInfs(hbnhms.let.cop.bbs.com.service.TemplateInfVO)
     */
